namespace GhabzinoBot
{
    static class ConstantStrings
    {
        ...
        public const string TrafficFinesInquery = "خلافی";
        public const string MciMobileBillInquiry = "تلفن همراه";
        public const string FixedLineBillInquiry = "تلفن ثابت";

        public const string paymensts = "پرداختی ها";
        public const string history = "سوابق";
        public const string bill = "قبض";
        ...
        public const string MciMobileBillInquiryNone = "لطفا شماره تلفن همراه را وارد کنید یا به صفحه اصلی باز گردید:";
