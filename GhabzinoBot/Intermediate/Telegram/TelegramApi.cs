...
namespace GhabzinoBot
{
    public class TelegramApi
    {
        ...
        public TelegramApi()
        {
            ...
            _btnBills = new KeyboardButton("پرداختی ها");
            _btnHistory = new KeyboardButton("سوابق");
            _btnRecipt = new KeyboardButton("قبض");
            //==================================================================================
            ...
            _btnInlineAll = new InlineKeyboardCallbackButton(ConstantStrings.AddAllToPaymentList, ConstantStrings.AddAllToPaymentList);
        ...
        private static InlineKeyboardButton[][] CreateInlineKeyboard(KeyboardType keyboardType, params string[] optionalUrls)
        {
            ...
            switch (keyboardType)
            {
                ...
                case KeyboardType.ChooseToAddPayment:
                    _btnInlineGoToPaymentPageSingle.Url = optionalUrls?[0];
                    keyboard = new InlineKeyboardButton[][] { new InlineKeyboardButton[] { _btnInlinePrevious, _btnInlineNext, }, new InlineKeyboardButton[] { _btnInlineAddToPaymentList, }, new InlineKeyboardButton[] { _btnInlineAll, }, new InlineKeyboardButton[] { _btnInlineGoToPaymentPageSingle, }, };
                    break;
